    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        _isNewWorker ? '신규 근로자 등록' : (_selectedWorker != null ? '${_selectedWorker!.name} - 인사기록카드' : '근로자를 선택하세요'),
                  ...
                  if (_selectedWorker != null || _isNewWorker) ...[
                              ...
                              child: _selectedWorker?.photoUrl != null
                                  ...
                                  : Column(
                                      ...
                                      children: [
                                        ...
                                        Text('반명함', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                                      ],
                                    ),
                            ),
                            const SizedBox(height: 8),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 16),
                                  Expanded(child: _buildDropdown('성별', ['남', '여'], _gender, (v) => setState(() => _gender = v))),
                                ],
                              ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const SizedBox(width: 8),
                                          const Text('이력서 첨부', style: TextStyle(color: Colors.grey)),
                                          const Spacer(),
                                          TextButton(onPressed: () {}, child: const Text('파일 선택')),
                                        ],
                                      ),
                                    ),
                                  ),
                    ...
                    const Center(
                      child: Padding(
                        ...
                        child: Text('아래 목록에서 근로자를 선택하거나\n신규 등록 버튼을 클릭하세요.', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey)),
                      ),
                    ),
                  ],
                ],
          ...
          Row(
            children: [
              const Text('▶ 근로자 목록', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.indigo)),
              const Spacer(),
              SizedBox(
                width: 250,
                height: 40,
